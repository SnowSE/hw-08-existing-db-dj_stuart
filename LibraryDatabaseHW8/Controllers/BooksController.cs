...
namespace LibraryDatabaseHW8.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var libraryDbContext = _context.Book.Include(b => b.Author).Include(b => b.SpecialCollection);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SpecialCollectionId"] = new SelectList(_context.SpecialCollection, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BookTitle,PublishedYear,ShelfPosition,SpecialCollectionId,AuthorId")] Book book)
        {
